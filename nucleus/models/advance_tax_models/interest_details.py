...
class InterestDetails(Base):
    ...
    it_refund_interest_reit: Mapped[float] = mapped_column(Float, default=0.0,server_default="0")
    ...
    foreign_interest_reit: Mapped[float] = mapped_column(Float, default=0.0,server_default="0")
