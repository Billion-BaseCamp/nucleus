...
class ITRForeignSalary(Base):
    ...
    employer_name: Mapped[str] = mapped_column(String(125), nullable=False, default="")
    taxable_salary: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2),nullable=True, default=0)
    ...
    gross_salary: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2),nullable=True, default=0)
    tax_exemption_portion: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2),nullable=True, default=0)
    taxable_gross: Mapped[Optional[Decimal]] = mapped_column(Numeric(18, 2),nullable=True, default=0)
