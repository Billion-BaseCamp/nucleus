...
from sqlalchemy import  DateTime, Float, ForeignKey, String, UUID as SQLUUID, Boolean, text
...
class TaxProfile(Base):
    ...
    tax_regime: Mapped[str] = mapped_column(String, default="NEW", nullable=False, server_default="NEW")
