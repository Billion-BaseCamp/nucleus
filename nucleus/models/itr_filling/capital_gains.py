...
class ITRCGHPEntry(Base):
    ...
    share_of_capital_gain_without_indexation: Mapped[Decimal] = mapped_column(Numeric(5, 2), nullable=False, default=0)
    share_of_capital_gain_with_indexation: Mapped[Decimal] = mapped_column(Numeric(5, 2), nullable=False, default=0)
