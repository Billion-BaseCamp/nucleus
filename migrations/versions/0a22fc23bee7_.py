...
Revision ID: 0a22fc23bee7
Revises: 707d1b388f17
Create Date: 2026-01-22 13:07:51.740204
...
revision: str = '0a22fc23bee7'
down_revision: Union[str, Sequence[str], None] = '707d1b388f17'
...
def upgrade() -> None:
    ...
    op.alter_column(
        "real_estate",
        "owners",
        existing_type=sa.VARCHAR(),   # NOT TEXT
        type_=sa.Integer(),
        postgresql_using="owners::integer",
...
def downgrade() -> None:
    ...
    op.create_foreign_key(op.f('real_estate_financial_year_id_fkey'), 'real_estate', 'financial_years', ['financial_year_id'], ['id'], ondelete='CASCADE')
    ...
    sa.ForeignKeyConstraint(['financial_year_id'], ['financial_years.id'], name=op.f('rsu_vesting_financial_year_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['financial_year_id'], ['financial_years.id'], name=op.f('cash_flow_office_financial_year_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['financial_year_id'], ['financial_years.id'], name=op.f('soa_master_financial_year_id_fkey'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['financial_year_id'], ['financial_years.id'], name=op.f('tax_records_financial_year_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['financial_year_id'], ['financial_years.id'], name=op.f('cash_flows_financial_year_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['financial_year_id'], ['financial_years.id'], name=op.f('incomes_financial_year_id_fkey'), ondelete='CASCADE'),
