...
class ForeignOtherCapitalAssets(Base):
    __tablename__ = "foreign_other_capital_assets"
    ...
    country: Mapped[Optional["CountryLookup"]] = relationship("CountryLookup", back_populates="foreign_other_capital_assets")
    ...
    income_derived_from_asset: Mapped[Decimal] = mapped_column(DECIMAL(15, 2), nullable=True)
