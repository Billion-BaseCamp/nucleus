...
class ITRForeignSalary(Base):
    ...
    gross_salary: Mapped[Decimal] = mapped_column(Numeric(18, 2), default=0)
    tax_exemption_portion: Mapped[Decimal] = mapped_column(Numeric(18, 2), default=0)
    ...
    net_taxable_salary: Mapped[Decimal] = mapped_column(Numeric(18, 2), default=0)
    tax_available_for_credit: Mapped[Decimal] = mapped_column(Numeric(18, 2), default=0)
