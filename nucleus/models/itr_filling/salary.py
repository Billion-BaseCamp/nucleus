...
class ITRSalaryEmployer(Base):
    ...
    tds_salary_entries: Mapped[List["ITRTDSSalary"]] = relationship(
        "ITRTDSSalary",
        back_populates="salary_employer",
        foreign_keys="ITRTDSSalary.salary_employer_id",
    )
...
class ITRForeignSalary(Base):
    ...
    gross_salary: Mapped[Decimal] = mapped_column(Numeric(18, 2),nullable=True, default=0)
    tax_exemption_portion: Mapped[Decimal] = mapped_column(Numeric(18, 2),nullable=True, default=0)
    taxable_gross: Mapped[Decimal] = mapped_column(Numeric(18, 2), default=0)
    total_deductions: Mapped[Decimal] = mapped_column(Numeric(18, 2),nullable=True, default=0)
    net_taxable_salary: Mapped[Decimal] = mapped_column(Numeric(18, 2),nullable=True, default=0)
    tax_available_for_credit: Mapped[Decimal] = mapped_column(Numeric(18, 2),nullable=True, default=0)
