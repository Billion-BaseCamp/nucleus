...
from sqlalchemy import Boolean, Date, DateTime, Enum, ForeignKey, Numeric, String, UniqueConstraint, UUID as SQLUUID
...
class Client(Base):
    ...
    balance_tax: Mapped[Optional[Decimal]] = mapped_column(Numeric(15, 2), nullable=True)
