...
class InterestDetails(Base):
    ...
    fd_interest_tax_rate: Mapped[float] = mapped_column(Float, default=0.0,server_default="0")
    savings_interest: Mapped[float] = mapped_column(Float, default=0.0)
    savings_tds: Mapped[float] = mapped_column(Float, default=0.0)
    savings_interest_tax_rate: Mapped[float] = mapped_column(Float, default=0.0,server_default="0")
    other_interest: Mapped[float] = mapped_column(Float, default=0.0)
    other_tds: Mapped[float] = mapped_column(Float, default=0.0)
    other_interest_tax_rate: Mapped[float] = mapped_column(Float, default=0.0,server_default="0")
    ...
    it_refund_interest_tax_rate: Mapped[float] = mapped_column(Float, default=0.0,server_default="0")
    ...
    foreign_interest_tax_rate: Mapped[float] = mapped_column(Float, default=0.0,server_default="0")
